    ...
    async def build(
        ...
        *,
        ...
        return {
            ...
            "devices": await self._devices(start, end),
            "media": await self._media(start, end),
            "realtime": await self._realtime(start, end),
            "inspections": await self._inspections(start, end),
            "alarms": await self._alarms(start, end),
            "locations": await self._locations(start, end),
            "data_quality": await self._data_quality(start, end),
        }
