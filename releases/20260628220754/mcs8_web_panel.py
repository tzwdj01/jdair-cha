...
<header>
  <h1>京东航空维修部视频记录系统</h1>
  <nav class="topnav">
    <button id="nav-dashboard" class="active" onclick="showView('dashboard')">首页工作台</button>
    ...
    <button class="ghost" onclick="logoutMcs8()">退出</button>
  </nav>
  <div id="status" class="status"></div>
</header>
<button id="sidebarToggle" class="sidebar-toggle-btn" onclick="toggleSidebar()" aria-expanded="true" aria-controls="sidebar">一键折叠 ◀</button>
<div class="layout">
  <aside id="sidebar">
    <div class="side-head">
      <div class="summary">
